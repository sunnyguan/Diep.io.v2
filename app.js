...
setInterval(function(){
	...
	for(var i in SOCKET_LIST){
		...
		if(typeof Player.list[socket.id] !== 'undefined'){
			pack.square = Square.getRequired(Player.list[socket.id]);
			pack.triangle = Triangle.getRequired(Player.list[socket.id]);
